...
public class DataLoader implements CommandLineRunner {
        ...
        private void createSampleUsers() {
                // 각 등급별로 샘플 사용자 생성
                createSampleUserIfNotExists("egg_user", "1234", "김알이", "egg@test.com", "010-1111-1111", 2005,
                                MemberGrade.EGG);
                ...
                createSampleUserIfNotExists("chick_user", "1234", "박병아리", "chick@test.com", "010-3333-3333", 2001,
                                MemberGrade.CHICK);
                createSampleUserIfNotExists("young_bird_user", "1234", "최어린새", "youngbird@test.com", "010-4444-4444",
                                1999,
